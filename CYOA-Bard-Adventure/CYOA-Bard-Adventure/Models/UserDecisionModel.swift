...
class UserDecisionModel {
    ...
    let neutralButtonsDictionary = ["scene1": "Shout a greeting and hope someone does (or does not) respond", "scene2": "Hello"  , "scene3": "Go outside and fashion a torch", "scene4" : "Throw your rations at him and run", "scene6" : "Creep towards the door to try and get a peek around the corner", "scene10": ""]
